      ...
      <section class="w3l-about-breadcrumb">
        <div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 pt-5 pb-4">
          <div class="container pt-lg-5 pt-md-3 py-lg-4 pb-md-3">
            <h2 class="title">ENTERTAINMENT NEWS</h2>
      ...
      <div class="w3l-news" id="news">
        <section id="grids5-block" class="py-5">
          <div class="container py-lg-5 py-md-4 py-2">
            <h3 class="title-big text-center">Entertainment News</h3>
            <div class="row mt-lg-5 mt-4" id="news api">
            <Entertainmentdata/></div>
          </div>
        </section>
      </div>
...
export function Entertainmentdata() {
...
export function SubEntertainment(props) {
  return (
